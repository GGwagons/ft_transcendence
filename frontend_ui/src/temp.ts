  ...
  private apiUrl: string = '';
      ...
      this.shadowRoot!.innerHTML = `
        ...
        <body class="overflow-hidden">
          <div class="flex flex-col justify-center items-center h-screen bg-[#232946]">
            <h1 class="text-4xl font-bold text-white mb-6">Avatar Upload</h1>
    ...
    private setupListeners(): void {
      ...
      form.addEventListener('submit', async (event: Event) => {
        ...
        try {
          this.apiUrl = getApiUrl('testUpload');
          ...
          const fileUrl = `${baseUrl}${result.fileUrl}`; // Construct the full URL for the avatar image

          console.log('File uploaded successfully:', result);
          uploadedImageDiv.innerHTML = `<img src="${fileUrl}" alt="Uploaded Image" class="max-w-xs rounded-md shadow-md" />`; // Display the image
